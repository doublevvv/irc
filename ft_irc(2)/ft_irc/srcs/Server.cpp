...
// 		case CAP:
// 			std::cout << ":server CAP * LS :KICK INVITE TOPIC MODE\r\n";
// 			break ;
...
//     {
//         send(*msg_it->second.begin(), msg_it->first.c_str(), msg_it->first.size(), 0);
// 		std::cout << "fd: " << (*it)->getFd() << " message: " <<msg_it->first.c_str() << std::endl;
